...
export default class OverlayPo {
    readonly page: Page;
    ...
    constructor(page: Page) {
        ...
        this.applyButton = page.locator('#button_18');
    ...
    async openOverlay(): Promise<void> {
        await this.goToNextDate(); // Perform the next date navigation.
        await this.page.waitForLoadState('networkidle'); // Ensure all network activity is idle.
        await this.legOverlayLink.first().click(); // Click the overlay link.
    }
