...
test.describe.skip("Overlay Functionality", () => {
    ...
    test.describe("Overlay Header Functionality", () => {
        ...
        test("Ensures that the leg overlay is visible and the leg information is correctly displayed.", async () => {
        ...
        test("Validates the 'Previous' button's functionality and navigation capability", async () => {
